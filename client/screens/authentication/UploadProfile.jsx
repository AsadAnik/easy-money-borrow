    ...
    const uploadToCloudinary = (dataResult) => {
        ...
        fetch(CLOUDINARY_URL, {
            ...
            .then(async R => {
                ...
                setData({
                    ...data,
                    profilePicture: dataResult.fileName,
                    profilePictureURI: cloudData.url,
                });
        ...
        >
            ...
            >
                <View style={{ alignItems: 'center' }}>
                    <ImagePicker
                        image={data.profilePictureURI ? { uri: data.profilePictureURI } : require('../../assets/images/avatar-male.png')}
                        height={200}
                        width={200}
