    ...
    if (data && companyData) {
        return (
            <View style={styles.container}>
                ...
                <View style={styles.row}>
                    <View style={styles.col}>
                        <Text style={styles.colHeadingText}>{data.staticAmounts} TK</Text>
                        {renderStatus(data.status)}
                    </View>

                    <View style={styles.col}>
                        <Text style={styles.colHeadingText}>{calculateWithInterest(data.staticAmounts, companyData.offersRate)} TK</Text>
                ...
                <View style={styles.row}>
                    <View style={styles.col}>
                        ...
                        <Text style={styles.colText}>REMAINING DURATIONS</Text>
                    </View>

                    <View style={styles.col}>
                        <Text style={styles.colHeadingText}>{data.request === 'ACCEPTED' ? data.amounts : calculateWithInterest(data.amounts, companyData.offersRate)} TK</Text>
                        <Text style={styles.colText}>REMAINING AMOUNTS</Text>
                    </View>
                </View>

                {/* <View style={styles.row}>
                    <View style={styles.col}>
                        <Text style={styles.colHeadingText}>{data.request === 'ACCEPTED' ? data.payPerMonth : calculateWithPayDuration(data.amounts, companyData.offersRate, data.payDuration)} TK</Text>
                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.col}>
                        <Text style={styles.colHeadingText}>{data.staticPayDuration} Months</Text>
